# -*- coding: utf-8 -*-
# Global settings for django_angular_tests project.
...
ANONYMOUS_USER_ID = -1
SITE_ID = 1
SECRET_KEY = '_l&i@snib9qscu%z4@+5=s^v6#be1@2rpu-&2bbq0ssr(vqc+e'
ROOT_URLCONF = 'django_angular_tests.urls'
WSGI_APPLICATION = 'django_angular_tests.wsgi.application'
